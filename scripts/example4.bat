...
gdal_translate -of PDF %BASE%\tmp\base.tif %BASE%\pdf\example4.pdf -co EXTRA_RASTERS=%BASE%\data\raster\madrid.tif,%BASE%\data\raster\overlay.tif -co EXTRA_RASTERS_LAYER_NAME="base","overlay"
